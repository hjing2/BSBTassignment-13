...
function App() {
  return (
    <div className="App">
      ...
      <h2>Haodan Jing Coding Assignment 12</h2>
      ...
      <HeroImage
        src="https://www.dmacg.net/wp-content/uploads/2022/05/1-7.jpg"
        alt="hero image"
      />
      <h3>Img Component</h3>
      <Img
        src="https://kk-promote-template.v3mh.com/answer-admin/prod/image/7g4EHNBGy/24-%E5%9B%BE%E7%89%87.jpg"
        alt="image"
      />
